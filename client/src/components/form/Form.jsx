...
export default function Form() {
  ...
  const {types,pokemonCreated} = useSelector(s=>s)
  ...
  return (
    <>
      <div className={style.container}>
        ...
        ?<span className={style.popUp}>{' Ya hay pokemons con ese nombre o imagen! ⚠️'}</span>
        ...
        <form onSubmit={handleSubmit} className={style.form}>
          ...
          <div className={style.inputs}>
            <label id='DEFENSE'> DEFENSE: </label>
      ...
      <div className={style.counter_form}>
        ...
        :<img src={pokeimg.img[71]} className={style.img_bar} alt={pokemon.name} style={{width:'250px',height:'250px'}}/>}
        <div>
          <h1>{pokemon.name}</h1>
